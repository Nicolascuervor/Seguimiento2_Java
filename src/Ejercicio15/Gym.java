    ...
    public void menuPay(){
         ...
         switch (decision){
             case 1:
                 ...
                 if(decision2 == JOptionPane.YES_OPTION) JOptionPane.showMessageDialog(null,"Your payment has been successfully porcessed");
             ...
             case 2:
                 ...
                 if(decision3 == JOptionPane.YES_OPTION) JOptionPane.showMessageDialog(null,"Your payment has been successfully porcessed");
                 else JOptionPane.showMessageDialog(null,"Your payment has been canceled successfully");
                 break;
             case 3:
                 int decision4 = JOptionPane.showConfirmDialog(null,"Are you sure you want to pay 86000 for 3 months?");
                 if(decision4 == JOptionPane.YES_OPTION) JOptionPane.showMessageDialog(null,"Your payment has been successfully porcessed");
                 else JOptionPane.showMessageDialog(null,"Your payment has been canceled successfully");
                 break;
             case 4:
                 break;
